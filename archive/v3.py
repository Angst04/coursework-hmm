...
class MainApp(tk.Tk):
    ...
    def open_1d(self):
        ...
        # Спираль Улама
        self.spiral_frame = ttk.Frame(tab_control)
        self.draw_spiral(self.spiral_frame, data)
        tab_control.add(self.spiral_frame, text="Спираль Улама")
        
        # Гистограмма
        self.hist_frame = ttk.Frame(tab_control)
        self.draw_histogram(self.hist_frame, data)
        tab_control.add(self.hist_frame, text="Гистограмма")
        
        # Замощение
        self.tiling_frame = ttk.Frame(tab_control)
        self.draw_tiling(self.tiling_frame, data)
        tab_control.add(self.tiling_frame, text="Замощение")
        
        # Точечный график
        self.scatter_frame = ttk.Frame(tab_control)
        self.draw_scatter(self.scatter_frame, data)
        tab_control.add(self.scatter_frame, text="Точечный график")
